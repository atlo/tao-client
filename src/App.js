    ...
    return (
      <div>
        <div className='container'>
          <p>Egy helyen a látványcsapatsportokba (foci, jégkorong, kézilabda, kosárlabda, vízilabda) öntött közpénzek több évnyi dokumentációja. Kereshető adatbázis az EMMI-nek leadott támogatási határozatokból, melyekből kiderül, hogy mely cégek melyik sportegyesületnek mennyi TAO-pénzt adtak 2011 és 2016 között. Keressen cég, település, sportág vagy egyesület alapján!</p>
